local telescope_mapper = require "bunny.telescope.mappings"
...
return function(client, bufnr)
  ...
  vim.keymap.set("n", "<leader>brn", vim.lsp.buf.rename, { buffer = 0, desc = "LSP Rename symbol under cursor" })
  vim.keymap.set("i", "<c-h>", vim.lsp.buf.signature_help, { buffer = 0, desc = "LSP Signature help" })
  vim.keymap.set("n", "<leader>bo", ":LspRestart<cr>", { noremap = true, desc = "LSP Restart Server" })
  vim.keymap.set("n", "<leader>ba", ":LspStart<cr>", { noremap = true, desc = "LSP Start Server" })
